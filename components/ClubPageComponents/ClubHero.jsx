...
const ClubHero = () => {
  return (
    ...
    <div className=" bg-[#0058BF4F] h-[600px] w-full flex flex-col items-center pt-10">
        <div className="pt-10">
            <Image src='/assets/images/cell/ucc.png' alt="Logo" width={200} height={200} />
        </div>
        <div>
            <h1 className="text-white font-serif text-3xl">UNIVERSITY COMPUTER CENTER & DIGITAL AFFAIRS</h1>
        </div>
        <div className="sm:flex space-x-8 mt-4">
            <div className="border-l-8 border-white border-solid border"></div>
