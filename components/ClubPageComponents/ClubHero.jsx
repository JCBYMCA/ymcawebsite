  ...
  return (
    <div className="bg-[#161b25] relative">
      ...
      <div className=" bg-[#000000c6] h-[30vh] md:h-[70vh] w-full flex flex-col items-center pt-10 absolute top-0">
        <div className="pt-10">
          <Image src='/assets/images/cell/ucc.png' alt="Logo" width={150} height={150} />
        </div>
        <div>
          <h1 className="text-white text-xl text-center font-serif sm:text-2xl">UNIVERSITY COMPUTER CENTER & DIGITAL AFFAIRS</h1>
        </div>
