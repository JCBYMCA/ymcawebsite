    ...
    return (
        <div className="  text-white">
            ...
            <motion.div animate={{opacity:[0,1]}} transition={{delay:0.8}} className={'w-20 '}>
                <h1 className={'md:ml-20 ml-5 mt-64 md:mt-52 md:w-[44rem] w-[16rem] text-4xl md:leading-[5rem] z-10 relative font-bold md:text-5xl '}>{t("tagline")}</h1>
                <h1 className={'text-xl ml-[35rem] italic w-[16rem]'}>~ {t('jcbose')}</h1>
            </motion.div>
