  ...
  theme: {
    extend: {
      ...
      backgroundImage: theme => ({
        ...
        'computer-department-bg-1': "url('/assets/images/computerDepartmentBg.png')",
        'computer-department-bg-2': "url('/assets/images/faculty/neelamduhan.png')",
        'computer-department-bg-3': "url('/assets/images/computerDepartmentBg.png')",
        'computer-department-bg-4': "url('/assets/images/computerDepartmentBg.png')",
      }),
    },
  },
  plugins: [],
